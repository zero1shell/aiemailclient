        ...
        <>
            ...
            <div className="min-h-screen flex flex-col items-center pt-56 relative z-[10]">
                ...
                <p className="text-xl mb-8 text-gray-600 max-w-xl text-center">
                    AI Powerd Email Clinet is a minimalistic, AI-powered email client that empowers you to manage your email with ease.
                </p>
                <div className="space-x-4">
                    <Button>
                        <Link href="/mail">Get Started</Link>
                    </Button>
                    <Link href='https://google.com?utm=zero1shell'>
